  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="inset-x-1 -bottom-px bg-gradient-to-r from-blue-500/0 via-blue-500/40 to-blue-500/0 dark:from-blue-400/0 dark:via-blue-400/40 dark:to-blue-400/0 absolute h-px" />
        )}
      </Link>
    </li>
  )
